        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="card-body summary">
                    ...
                    <h3>{{ $stats['unique_listing_count'] }}</h3>
                    <p>Unique Listings</p>
                    <hr style="border:0; border-top: 1px solid #eee; margin: 1rem 0;">
                    <h3>{{ $stats['duplicate_listing_count'] }}</h3>
                    <p>Duplicate Listings (unmerged)</p>
                    <hr style="border:0; border-top: 1px solid #eee; margin: 1rem 0;">
                    <h3>{{ $stats['incomplete_listing_count'] }}</h3>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table>
                        ...
                        <tbody>
                            @foreach($stats['city_wise'] as $row)
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table>
                        ...
                        <tbody>
                            @foreach($stats['category_city_wise'] as $row)
                            <tr><td>{{ $row->category }}</td><td>{{ $row->city }}</td><td>{{ $row->total }}</td></tr>
                            @endforeach
                        </tbody>
                    </table>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table>
                        ...
                        <tbody>
                            @foreach($stats['category_area_wise'] as $row)
                            <tr><td>{{ $row->category }}</td><td>{{ $row->area }}</td><td>{{ $row->total }}</td></tr>
                            @endforeach
                        </tbody>
                    </table>
                </div>
